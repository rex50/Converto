...
internal class ResultExtensionsTest {
    ...
    @Test
    fun `safely map for unsuccessful result`() = runBlocking {
    ...
    @Test
    fun `safely map for successful result`() = runBlocking {
    ...
    @Test
    fun `safely map for successful result but exception while mapping`() = runBlocking {
        val result = Result.Success("Data")
